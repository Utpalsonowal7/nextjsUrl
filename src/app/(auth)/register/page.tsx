               ...
               <div className="flex flex-col justify-center items-center gap-10 py-10">
                    ...
                    <div className="flex flex-col gap-2 items-center">
                         ...
                         <p className="font-sm text-muted">
                              Start creating your links now
                         </p>
                    </div>
                    <div className="flex flex-col gap-4 bg-cardBg border border-cardBorder py-10 px-6  md:px-18 bg-">
                         <button
                              className="flex items-center bg-background rounded gap-2 border border-cardBorder px-6 py-3 cursor-pointer"
                    ...
                    <div className="flex text-muted gap-1">
                         ...
                         <Link href="/login" className="text-[#c43a21]">
                              Sign in
                         </Link>
                    </div>
               </div>
